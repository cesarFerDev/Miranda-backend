...
import Joi from 'joi';
import { MongoUser } from '@src/mongoSchemas/userSchema';
...
exports.postUser = expressAsyncHandler(async(req: Request<{}, MongoUser, MongoUser>, res: Response) => {
...
//Edit a single User
exports.putUser = expressAsyncHandler(async(req: Request<{id: string}, User, Partial<MongoUser>>, res: Response) => {
