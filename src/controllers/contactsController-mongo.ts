...
import {get, post, put, delContact} from "../repositories/contactsRepository/contactsRepository-mongo";
import Joi from 'joi';
...
exports.postContact = expressAsyncHandler(async(req: Request<{}, MongoContact, MongoContact>, res: Response) => {
...
//Archive Contact
exports.putContact = expressAsyncHandler(async(req: Request<{id: string}, MongoContact, {}>, res: Response) => {
